...
const dictionaries: Record<Language, Dict> = {
  ...
  hinglish: {
    tagline: "Awaaz → Tasks, turant",
    menu: "Menu", account: "Account", theme: "Theme", language: "Language",
    accountSettings: "Account settings", logout: "Log out", addAccount: "Naya account add karein", deleteAccount: "Account delete karein",
    deleteConfirmTitle: "Apna account delete karna hai?",
    deleteConfirmDesc: "Isse aapke saare tasks aur profile data permanently delete ho jayenge. Ye undo nahi ho sakta.",
    cancel: "Cancel", delete: "Delete",
    signIn: "Sign In", signUp: "Sign Up", email: "Email", password: "Password", name: "Naam", yourName: "Aapka naam",
    createAccount: "Account banayein", continueWithGoogle: "Google se continue karein", or: "ya",
    home: "Home", tasks: "Tasks",
    emptyTitle: "Bolo. Baaki hum sambhal lenge.",
    emptyDesc: "Neeche record button dabaye rakho aur bas bolo — Voxel aapke thoughts ko organized tasks mein convert kar dega.",
    holdToRecord: "Record karne ke liye dabaye rakho", listening: "Sun raha hai…", thinking: "Soch raha hai…",
    searchTasks: "Tasks search karein…",
    allCategories: "Saari categories", allPriorities: "Saari priorities", allStatus: "Saari status",
    active: "Active", completed: "Completed",
    anyTime: "Kabhi bhi", today: "Aaj", thisWeek: "Is hafte", overdue: "Overdue",
    high: "High", medium: "Medium", low: "Low",
    category: "Category", priority: "Priority", status: "Status", due: "Due",
    clearFilters: "Filters clear karein",
    noTasksYet: "Abhi tak koi task nahi. Shuru karne ke liye mic dabaye.",
    noMatch: "Aapke filters se koi task match nahi karta.",
    viewActive: (n) => `${n} active task${n > 1 ? "s" : ""} dekhein →`,
    addedTasks: (n) => `${n} task${n > 1 ? "s" : ""} add ho gaye`,
    noTasksDetected: "Koi task detect nahi hua.", didntCatch: "Samajh nahi aaya — phir se try karein.",
    extractingTasks: "Tasks extract ho rahe hain…",
    themeDefault: "Default (Neon)", themeDefaultDesc: "Original electric blue + purple",
    themeClassic: "Classic", themeClassicDesc: "Halka dark slate",
    themeLight: "Light", themeLightDesc: "Bright mode",
  },
  zh: {
    tagline: "语音 → 任务,即时完成",
